...
int A=1,B=1,C=5000000,basicchoice,sectorchoice;
...
void registeredinformation()
{
    ...
    Memberform person;
    string finddata;
    ifstream kout("TXT/data.txt", ios::app);
    ...
    if (id == 'Y' || id == 'y')
    {
            ...
            RenderWindow window(VideoMode(900,500), "Kebele Identification Card");
            ...
            idpicture.loadFromFile("Images/"+ finddata +".png");
            //idpicture.loadFromFile("Images/quincy.jpg");
            ...
            Text texttitle ("addis ababa, Kebele Identification Card",font4,45);
            ...
            while(window.isOpen())
            {
                ...
                if (j1>=-390 && j1<0 && i1==0) j1+=4;
                if (j2>=-390 && j2<0 && i2==895) j2+=4;
                if (i3>=-916 && i3<-8 && j3==495) i3+=8;
                if (a<150) a=150;
                if (a>=150 && a<820 && k==1)
                {
                    a+=4;
...
{
    Music  music;
        music.openFromFile("Sounds/tryh.ogg");
        music.play();
    system ("cls");
    system ("color FC");
    ...
    RenderWindow welcomewindow (VideoMode(850,600) , " CREDITS");
        ...
        while (welcomewindow.isOpen())
        {
            Event event;
                ...
                Text textinfo ("\tKEBELE MANAGEMENT SOFTWARE",font,25);
                ...
                text2.setPosition(200,j+450);
                text3.setPosition(250,j+850);
                text4.setPosition(250,j+1700);
                text5.setPosition(250,j+2300);
                text6.setPosition(20,j+2800);
                text7.setPosition(30,j+2850);
                text8.setPosition(130,j+3050);
...
void settings()
{
    ...
    system("cls");
    B = 1;
    cout<<"\n\t Pop-up Window Will Appear When You Return To Main Screen.\n";
    cout<<"\n\tPress any key to proceed...\n";
    getch();
}
void exit()
...
int main()
{
    ...
    {
       /* Music  music;
        //music.openFromFile("Sounds/orchestral.ogg");
        music.openFromFile("Sounds/trap_android.mp3");
        music.setPlayingOffset(seconds(5));
        music.setPitch(2.5);
        music.setVolume(50);
        //music.setLoop(true);
        music.play();*/
        SoundBuffer buffer;
        Sound sound;
        buffer.loadFromFile("Sounds/hangouts_video_call.ogg");
        //buffer.loadFromFile("Sounds/flourish.mid");
        sound.setBuffer(buffer);
        sound.setPitch(0.49);
        sound.play();

        RenderWindow welcomewindow (VideoMode(950,500) , "Welcome To Kebele Management Software");
        ...
        border1.setFillColor (Color::White);
        border2.setFillColor (Color::Red);
        border3.setFillColor (Color::Red);
        border4.setFillColor (Color::White);
        ...
        while (welcomewindow.isOpen())
        {
            Event event;
                ...
                if (i>=5 && i<933 && j==5) i+=5;
                if (i >= 780) sound.stop();
                if (i>933) i=933;
                if (j>=5 && i==933 && j<483) j+=4;
                //if (j >= 250) sound.stop();
                if (j>483) j=483;
                if (j==483 && i>5) i-=5;
                if (i<5) i=5;
                ...
                Font font;
                font.loadFromFile("Fonts/Xcelsion Italic.ttf");
                Text textinfo ("   WELCOME TO KEBELE MANAGEMENT \n\t\t\t\t\tSOFTWARE",font,30);
        ...
        system("title Kebele Management Software");
        system("color F4");
        system("cls");
        cout<<"\n\n\n\n\n\n\n";
        text("\t      ***************************************************\n");
